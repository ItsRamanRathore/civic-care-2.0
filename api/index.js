...
// Standard Routes (Relative to /api/index.js)
...
app.get(['/api/health', '/health'], (req, res) => {
  res.status(200).json({ status: 'ok', engine: 'v2.0-canonical-standard' });
});
...
app.all('*', (req, res) => {
  res.status(404).json({ 
    ...
    url: req.url,
    method: req.method,
    hint: 'Ensure your app.use routes in api/index.js match the path Vercel is sending.'
  });
});
